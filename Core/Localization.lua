...
BINDING_HEADER_BINDPAD = "BetterBind";
BINDING_NAME_TOGGLE_BINDPAD = "Toggle BetterBind";
BINDPAD_TITLE = "BetterBind";
BINDPAD_TITLE_1 = "BetterBind Profile1";
BINDPAD_TITLE_2 = "BetterBind Profile2";
BINDPAD_TITLE_3 = "BetterBind Profile3";
...
BINDPAD_TEXT_SPECIFIC_EXTRA_TAB4 = "4";
...
BINDPAD_TEXT_CANNOT_PLACE = "ERROR: %s can not be placed in BetterBind slot.";
BINDPAD_TEXT_CANNOT_BIND = "Cannot change key bindings while in combat."
BINDPAD_TEXT_OBSOLATED = "Older version's savefile for BetterBind is now obsolated and deleted.  Sorry for inconvenience.";
...
BINDPAD_TEXT_ERR_UNIQUENAME = "You must enter unique name for BetterBindMacro.";
...
BINDPAD_TEXT_ERR_BINDPADMACRO_INCOMBAT = "Cannot edit BetterBindMacro while in combat.";
...
BINDPAD_TOOLTIP_BINDPADMACRO = "BetterBindMacro:%s";
...
BINDPAD_TEXT_USAGE =
   "Usage: /betterbind [command] or /bb [command] \n"..
      "    /betterbind : Toggle BetterBind.\n" ..
      "    /betterbind list : List profiles in saved variables.\n" ..
      "    /betterbind delete REALMNAME_CHARACTERNAME : Delete a profile for the named character.\n"..
      "    /betterbind copyfrom REALMNAME_CHARACTERNAME : Copy a profile from the named character.\n"..
      "    Example: /bb copyfrom Blackrock_foobar";
...
if(GetLocale() == "zhTW") then
	BINDING_HEADER_BINDPAD = "BetterBind";
	BINDING_NAME_TOGGLE_BINDPAD = "開啟BetterBind";
	BINDPAD_TITLE = "BetterBind";
	...
	BINDPAD_TEXT_CANNOT_PLACE = "錯誤: %s 不能被放置在 BetterBind 中。";
	...
	BINDPAD_TOOLTIP_BINDPADMACRO = "BetterBind 巨集: %s";
	...
	BINDPAD_TOOLTIP_TAB5 = "%s 專用 4";
	BINDPAD_TOOLTIP_SHOW_HOTKEY = "自動在動作條上顯示被 BetterBind 綁定過的按鍵的快捷鍵文字.";
	BINDPAD_TOOLTIP_CREATE_MACRO = "";
	BINDPAD_TOOLTIP_CLICK_USAGE1 = "右擊以編輯巨集\n左擊以進行綁定";
	BINDPAD_TOOLTIP_CLICK_USAGE2 = "右擊以轉換\n左擊以進行綁定";
	BINDPAD_TOOLTIP_CLICK_USAGE = "左鍵點擊以設定按鍵";
end

if(GetLocale() == "zhCN") then
	BINDING_HEADER_BINDPAD = "BetterBind";
	BINDING_NAME_TOGGLE_BINDPAD = "开启BetterBind";
	BINDPAD_TITLE = "BetterBind";
	...
	BINDPAD_TEXT_CANNOT_PLACE = "错误: %s 不能被放置在 BetterBind 中。";
	...
	BINDPAD_TOOLTIP_BINDPADMACRO = "BetterBind 宏: %s";
	...
	BINDPAD_TOOLTIP_TAB5 = "%s 专用 4";
	BINDPAD_TOOLTIP_SHOW_HOTKEY = "自动在动作条上显示被 BetterBind 绑定过的按键的快捷键文字。";
	BINDPAD_TOOLTIP_CREATE_MACRO = "";
	BINDPAD_TOOLTIP_CLICK_USAGE1 = "右击以编辑宏\n左击以进行绑定";
	BINDPAD_TOOLTIP_CLICK_USAGE2 = "右击以转换\n左击以进行绑定";
	BINDPAD_TOOLTIP_CLICK_USAGE = "左键点击以设置按键";
end
